...
include("db.php");
	...
	$row=mysqli_fetch_assoc($query) or die("data not found!");
...
<body>
	<div class="login_form">
		<form name="myForm" action="user.php" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
			<input type="hidden" name="user_id" value="<?php echo $row['id'];?>">
			<input type="hidden" name="update" value="update">
			<h2 > User Update Profile Form</h2>
			<div class="box_set">
				Full Name: <input type="text" name="fullname" id="fullname" class="fullname" value="<?php echo $row['full_name'];?>">
			  Email: <input type="email" name="email" id="email" value="<?php echo $row['email'];?>">
		    </div>
		    <br>
		    <div class="box_set">
		    Address:<input type="text" name="address" id="address" >
			  Profile Photo<input type="file" name="file" id="file">
		    </div>
		    <br>
		    <div class="box_set">
